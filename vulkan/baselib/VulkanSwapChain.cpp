...
VulkanSwapChain::DepthUnit VulkanSwapChain::create_depth(uint32_t width, uint32_t height)
{
  DepthUnit unit = {};
...
VkRenderPass VulkanSwapChain::create_render_pass()
{
...
std::vector<VkFramebuffer> VulkanSwapChain::create_frame_buffer(VkRenderPass vkPass, const DepthUnit& depthUnit) 
{
